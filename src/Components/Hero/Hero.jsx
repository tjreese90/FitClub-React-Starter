		...
		<div className="hero" id='home'>
			...
			<div className="left-h">
				...
				<div className="figures">
					<div>
						<span><NumberCounter end={140} start={100} delay='4' perFix="+" /></span>
						<span>expert coaches </span>
					</div>
					<div>
						<span><NumberCounter end={978} start={758} delay='4' perFix="+" /></span>
						<span>members joined</span>
					</div>
					<div>
						<span><NumberCounter end={50} start={0} delay='4' perFix="+" /></span>
